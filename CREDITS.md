...
| [Codicons](https://github.com/microsoft/vscode-codicons) | Bundled **icon** font — the UI's symbol glyphs (`SymbolThemeFontFamily`: window buttons, chevrons, nav icons) | CC-BY-4.0 (© Microsoft — the font/icons; the project's own code is MIT) |
...
| [Fluid.Avalonia.Acrylic](https://github.com/Alpaq92/Fluid.Avalonia.Acrylic) | The demo's cross-platform **Acrylic** window backdrop — a SkiaSharp `SKRuntimeEffect` frosted surface (Settings → Window). A repackaged fork of KaranocaVe's [LiquidGlassAvaloniaUI](https://github.com/KaranocaVe/LiquidGlassAvaloniaUI) | MIT (© KaranocaVe; fork © Alpaq92) |
...
| [Romzetron.Avalonia](https://github.com/Romzetron/Romzetron.Avalonia) | Reference for the solution structure / file-per-control semantic-brush styling | MIT |
| [country-list gist](https://gist.github.com/ssskip/5a94bfcd2835bf1dea52) | Country names for the `AutoCompleteBox` sample data | MIT |
