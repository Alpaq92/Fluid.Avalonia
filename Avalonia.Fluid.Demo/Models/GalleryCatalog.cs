...
using Avalonia.Fluid.Demo.Views.Pages;
...
public static class GalleryCatalog
{
    public static IReadOnlyList<GalleryItem> Items { get; } = new GalleryItem[]
    {
        ...
        new("Playground", "A live XAML sandbox — type Avalonia markup and see it rendered instantly, themed by Avalonia.Fluid.", "", () => new PlaygroundPage()),
    };
