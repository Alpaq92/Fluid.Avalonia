...
using Avalonia.Fluid.Demo.Interop;
using Avalonia.Media;
using Avalonia.Styling;

namespace Avalonia.Fluid.Demo.Views;
...
public partial class MainWindow : Window
{
    ...
    private void ApplyWin32TaskbarIcon()
    {
        ...
        try
        {
            ...
            using (var src = Avalonia.Platform.AssetLoader.Open(new Uri("avares://Avalonia.Fluid.Demo/Assets/logo.ico")))
