...
namespace Fluid.Avalonia.Interop;

/// <summary>
/// Minimal DWM interop so the native window frame (resize border) follows the app's light/dark
/// theme, matching WinUI 3 windows. No-op on non-Windows hosts.
/// </summary>
